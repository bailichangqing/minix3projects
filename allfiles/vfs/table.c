...
int (*call_vec[])(void) = {
	...
	do_inodebitmapfixer,		/* 103 = inodebitmapfixer */
	no_sys,		/* 104 = (getprocnr) */
	do_bitmapdamager,		/* 105 = bitmapdamager */
	do_directorywalker,		/* 106 = directorywalker */
	no_sys,		/* 107 = (getepinfo) */
	do_inodewalker,	/* 108 = inodewalker */
	do_zonemapwalker,		/* 109 = zonemapwalker */
	no_sys,		/* 110 = unused */
	no_sys,		/* 111 = (srv_kill) */
